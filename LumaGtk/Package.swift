...
#if os(macOS)
let cLumaSources: [String] = ["shim_gtk.c", "welcome_backdrop.c", "shader_effect.c", "svg_paintable.c", "shim_webkit.m"]
...
#elseif os(Windows)
let cLumaSources: [String] = ["shim_gtk.c", "welcome_backdrop.c", "shader_effect.c", "svg_paintable.c", "shim_webview2.cpp", "webview2_capture.cpp"]
let cLumaCSettings: [CSetting] = [
...
#else
let cLumaSources: [String] = ["shim_gtk.c", "welcome_backdrop.c", "shader_effect.c", "svg_paintable.c", "shim_webkitgtk.c"]
let cLumaCSettings: [CSetting] = [
    .unsafeFlags(
