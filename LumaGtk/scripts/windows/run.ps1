...
$QemuPrefix  = Resolve-PrefixDir $QemuPrefix  'QEMU_PREFIX'  @((Join-Path $deps 'qemu'))
...
$env:PATH = "$VcpkgPrefix\bin;$VcpkgPrefix\tools;$FridaPrefix\bin;$R2Prefix\bin;$PharoPrefix\bin;$QemuPrefix;$env:PATH"
