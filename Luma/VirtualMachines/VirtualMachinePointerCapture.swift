...
/// A guest shown in a panel waits to be clicked before it takes the pointer;
/// one filling the screen has already been asked for.
enum PointerCapturePolicy {
    case onClick
    case onAppear
}
...
struct VirtualMachinePointerCapture: PlatformViewRepresentable {
    ...
    final class PointerView: NSView {
        ...
        override func viewDidMoveToWindow() {
            ...
            if capturing == .onAppear, !isAbsolute {
                capturePointer()
            }
